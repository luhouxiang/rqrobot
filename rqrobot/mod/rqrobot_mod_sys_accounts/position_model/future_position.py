...
from rqrobot.model.base_position import BasePosition
from rqrobot.environment import Environment
from rqrobot.const import SIDE, POSITION_EFFECT, DEFAULT_ACCOUNT_TYPE
...
class FuturePosition(BasePosition):
    ...
    def apply_trade(self, trade):
        ...
        :param trade: rqrobot.model.trade.Trade
        :return: float
        """
