...
from rqrobot.const import EXC_TYPE, EXECUTION_PHASE
from rqrobot.events import EVENT
from rqrobot.utils.py2 import signature
from rqrobot.utils.exception import patch_user_exc, ModifyExceptionFromType
